...
class ExposeDetector(AnomalyDetector):
  ...
  EXPoSE calculates the likelihood of a data_origin point being normal by using
  the inner product of its feature map with kernel embedding of previous data_origin
  points. This measures the similarity of a data_origin point to previous points
  without assuming an underlying data_origin distribution.
